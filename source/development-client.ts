...
/** One Client development server presented and supervised by the CLI. */
export class DevelopmentClient {
  private readonly child: ChildProcess
  private readonly output: DevelopmentEvent[] = []
  ...
  private push(event: DevelopmentEvent) {
...
function outputEvent(stream: "out" | "err", chunk: unknown): DevelopmentEvent {
